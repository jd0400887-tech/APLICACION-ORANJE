...
const HomeView: React.FC<HomeViewProps> = ({ currentUser, assignedHotel }) => {
  ...
  return (
    <Box sx={{ p: 2, textAlign: 'center', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <Box sx={{ maxWidth: 600, width: '100%', margin: '0 auto' }}> {/* Centered wrapper */}
        ...
        {currentUser && (
          <Card elevation={3} sx={{ mb: 3, bgcolor: theme.palette.primary.light, width: '100%' }}>
            <CardContent>
              <Avatar
